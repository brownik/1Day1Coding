...
Difficulty: 0
Last Updated: 2023년 4월 27일 오전 9:34
Resolved: true

링크 - [옹알이 (1)](https://school.programmers.co.kr/learn/courses/30/lessons/120956)
...
class Solution {
    fun solution(babbling: Array<String>): Int {
        val answer = babbling.toMutableList()
        val babble = listOf("aya", "ye", "woo", "ma")
        for (i in answer.indices) {
            babble.forEach {
                answer[i] = answer[i].replace(it, "0")
            }
        }
        return answer.count {
            try {
