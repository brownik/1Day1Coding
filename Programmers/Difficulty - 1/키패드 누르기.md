...
Difficulty: 1
Last Updated: 2023년 5월 31일 오전 10:34
Resolved: true

링크 - [키패드 누르기](https://school.programmers.co.kr/learn/courses/30/lessons/67256)
...
class Solution {
    ...
    private fun checkCommon(num: Int, hand: String) {
        val leftDiff = getDistance(left, num)
        val rightDiff = getDistance(right, num)
        when {
            leftDiff < rightDiff -> {
                answer += "L"
                left = num
    ...
    private fun getDistance(point: Int, num: Int): Int =
        when (point - num) {
            -3, -1, 1, 3 -> 1
            -6, -4, -2, 2, 4, 6 -> 2
            -9, -7, -5, 5, 7, 9 -> 3
