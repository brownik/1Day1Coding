...
Last Updated: 2023년 4월 3일 오후 8:05

링크 - [추억 점수](https://school.programmers.co.kr/learn/courses/30/lessons/176963)
...
class Solution {
    fun solution(name: Array<String>, yearning: IntArray, photo: Array<Array<String>>): IntArray {
        val map = name.mapIndexed { i, n ->
            n to yearning[i]
        }.toMap()
        return photo.map { names ->
            var score = 0
            names.forEach { score += map[it] ?: 0 }
            score
        }.toIntArray()
    }
}
