...
링크 - [H-Index](https://school.programmers.co.kr/learn/courses/30/lessons/42747)
...
class Solution {
    fun solution(citations: IntArray): Int {
        var answer = 0
        for (i in citations.average().toInt() downTo 0){
            if (citations.count { it >= i } >= i) { answer = i; break }
        }
        return answer
    }
}
